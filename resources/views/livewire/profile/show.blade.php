        ...
        <form wire:submit.prevent="save" class="form form-horizontal">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <x-form.input lazy="true" name="passwordConfirmation" type="password" placeholder="Password Confirmation"/>
                    </div>

                    <div class="col-sm-{{ session()->has('notify-saved') ? '11' : '12' }} d-flex justify-content-end">
                        <x-base.button id="top-right" type="submit" title="Submit" class="primary me-1 mb-1"/>
                    </div>
                    <div
